...
| **04 Exfiltration** | `awk` on column **9** for bytes | Matches [`logs/network_connections.csv`](./04-data-exfiltration/logs/network_connections.csv) layout | **04** has CLI samples; PNG evidence optional until added. |
